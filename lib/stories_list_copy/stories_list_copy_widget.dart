...
import 'stories_list_copy_model.dart';
export 'stories_list_copy_model.dart';

class StoriesListCopyWidget extends StatefulWidget {
  const StoriesListCopyWidget({
    super.key,
    required this.matchedStories,
  });

  final List<String>? matchedStories;

  @override
  State<StoriesListCopyWidget> createState() => _StoriesListCopyWidgetState();
}

class _StoriesListCopyWidgetState extends State<StoriesListCopyWidget> {
  late StoriesListCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StoriesListCopyModel());
          ...
          child: StreamBuilder<List<UserStoriesRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                children: List.generate(columnUserStoriesRecordList.length,
                    (columnIndex) {
