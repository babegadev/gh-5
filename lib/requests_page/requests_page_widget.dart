                ...
                child: TabBarView(
                  ...
                  children: [
                    Padding(
                      ...
                      child: StreamBuilder<List<ChatRequestsRecord>>(
                        stream: queryChatRequestsRecord(
                          queryBuilder: (chatRequestsRecord) =>
                              chatRequestsRecord
                                  .where(
                                    'requested_user',
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ChatRequestsRecord>
                              columnChatRequestsRecordList = snapshot.data!;

                          return SingleChildScrollView(
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              children: List.generate(
                                  columnChatRequestsRecordList.length,
                                  (columnIndex) {
                                final columnChatRequestsRecord =
                                    columnChatRequestsRecordList[columnIndex];
                                return Align(
                                                      ...
                                                      return RichText(
                                                        ...
                                                        text: TextSpan(
                                                          children: [
                                                            ...
                                                            TextSpan(
                                                              text:
                                                                  ' is interested in your story on ',
                                                              style: TextStyle(
                                                                fontSize: 16.0,
                                                              ),
                                                            ),
                                                        ...
                                                        children: [
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  FFAppState()
                                                                          .currentlySelectedRequestedUser =
                                                                      columnChatRequestsRecord
                                                                          .requestingUser;
                                                                  setState(
                                                                      () {});
                                                          ...
                                                          FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              await columnChatRequestsRecord
                                                                  .reference
                                                                  .update(
                                                                      createChatRequestsRecordData(
                                                                status:
                                                                    'accepted',
                                                              ));
                                                              _model.usersArray =
                                                              ...
                                                              await chatsRecordReference
                                                                ...
                                                                ...createChatsRecordData(
                                                                  userA:
                                                                      currentUserReference,
                                                                  userB: columnChatRequestsRecord
                                                                      .requestingUser,
                                                                  lastMessage:
                                                                      '',
                                                                  lastMessageTime:
