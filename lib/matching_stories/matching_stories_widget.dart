...
class _MatchingStoriesWidgetState extends State<MatchingStoriesWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.currentUserStoryDocument = await queryUserStoriesRecordOnce(
      ...
      FFAppState().currentUserStory = _model.currentUserStoryDocument!.story;
      setState(() {});
      if (!(FFAppState().currentUserStory != null &&
          FFAppState().currentUserStory != '')) {
        return;
      }
      _model.matchedStoriesApiResponse = await QueryStoriesCall.call(
        authToken: currentJwtToken,
        query: FFAppState().currentUserStory,
      );

      if ((_model.matchedStoriesApiResponse?.succeeded ?? true)) {
        FFAppState().matchedStories = (getJsonField(
          (_model.matchedStoriesApiResponse?.jsonBody ?? ''),
          r'''$.result.ids''',
          true,
        ) as List)
